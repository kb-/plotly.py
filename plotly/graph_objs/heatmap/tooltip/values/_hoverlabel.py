...
class Hoverlabel(_BaseTraceHierarchyType):
    _parent_path_str = "heatmap.tooltip.values"
    _path_str = "heatmap.tooltip.values.hoverlabel"
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.heatmap.tooltip.values.hoverlabel.Font`
          - A dict of string/value properties that will be passed
            to the Font constructor

        Returns
        -------
        plotly.graph_objs.heatmap.tooltip.values.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, bgcolor=None, bordercolor=None, font=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objs.heatmap.toolti
            p.values.Hoverlabel`
        bgcolor
            Sets the background color of the hover label. By
            default uses the annotation's `bgcolor` made opaque, or
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.heatmap.tooltip.values.Hoverlabel
