...
class Values(_BaseTraceHierarchyType):
    _parent_path_str = "scattercarpet.tooltip"
    _path_str = "scattercarpet.tooltip.values"
    _valid_props = {
        "align",
        "arrowcolor",
        "arrowhead",
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.scattercarpet.tooltip.values.Font`
          - A dict of string/value properties that will be passed
            to the Font constructor

        Returns
        -------
        plotly.graph_objs.scattercarpet.tooltip.values.Font
        """
        return self["font"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.scattercarpet.tooltip.values.Hoverlabel`
          - A dict of string/value properties that will be passed
            to the Hoverlabel constructor

        Returns
        -------
        plotly.graph_objs.scattercarpet.tooltip.values.Hoverlabel
        """
    ...
    def _prop_descriptions(self):
        ...
        height
            ...
            will be clipped.
        hoverlabel
            :class:`plotly.graph_objects.scattercarpet.tooltip.valu
            es.Hoverlabel` instance or dict with compatible
            properties
        hovertext
    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.scattercarpet.tooltip.Values`
        align
            Sets the horizontal alignment of the `text` within the
            box. Has an effect only if `text` spans two or more
            lines (i.e. `text` contains one or more <br> HTML tags)
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.scattercarpet.tooltip.Values
constructor must be a dict or
an instance of :class:`plotly.graph_objs.scattercarpet.tooltip.Values`""")
